        ...
        <div class="container">
            ...
            <%
                ...
                try {
                    ...
                    String query = "SELECT * FROM dishes LIMIT 6";
                    resultSet = stmt.executeQuery(query);
            %>

            <!-- HTML and JSP code to display dishes -->
            <div class="row">
                <%
                        while(resultSet.next()) {
                            ...
                            int rsId = resultSet.getInt("rs_id");
                %>

                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        <div class="figure-wrap bg-image" data-image-src="admin/Res_img/dishes/<%= img %>"></div>
                        <div class="content">
                            <h5><a href="dishes.jsp?res_id=<%= rsId %>"><%= title %></a></h5>
                            <div class="product-name"><%= slogan %></div>
                            <div class="price-btn-block">
                                <span class="price">$<%= price %></span>
                                <a href="dishes.jsp?res_id=<%= rsId %>" class="btn theme-btn-dash pull-right">Order Now</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
                            ...
                            <ul>
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        String query = "SELECT * FROM res_category";
                                        resultSet = stmt.executeQuery(query);
                                %>

                                <!-- HTML and JSP code to display categories in a list -->
                                <ul>
                                <%
                                        while(resultSet.next()) {
                                            String categoryName = resultSet.getString("c_name");
                                %>
                                    <li><a href="#" data-filter=".<%= categoryName %>"> <%= categoryName %> </a> </li>
                                <%
                                        }
                                %>
                                </ul>
            ...
            <div class="row">
                ...
                <%
                    ...
                    Statement stmtRestaurants = null;
                    ResultSet resultSetRestaurants = null;
                    Statement stmtCategory = null;
                    ResultSet resultSetCategory = null;

                    try {
                        conn = DBConnection.getConnection();
                        String queryRestaurants = "SELECT * FROM restaurant";
                        stmtRestaurants = conn.createStatement();
                        resultSetRestaurants = stmtRestaurants.executeQuery(queryRestaurants);
                ...
                <%
                        while(resultSetRestaurants.next()) {
                            int categoryId = resultSetRestaurants.getInt("c_id");
                            String restaurantId = resultSetRestaurants.getString("rs_id");
                            String restaurantTitle = resultSetRestaurants.getString("title");
                            String restaurantAddress = resultSetRestaurants.getString("address");
                            String restaurantImage = resultSetRestaurants.getString("image");

                            String queryCategory = "SELECT * FROM res_category WHERE c_id='" + categoryId + "'";
                            stmtCategory = conn.createStatement();
                            resultSetCategory = stmtCategory.executeQuery(queryCategory);

                            if(resultSetCategory.next()) {
                                String categoryName = resultSetCategory.getString("c_name");

                %>
                                <!-- HTML and JSP code to display the restaurant -->
                                <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all <%= categoryName %>">
                                    <div class="restaurant-wrap">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                                <a class="restaurant-logo" href="dishes.jsp?res_id=<%= restaurantId %>">
                                                    <img src="admin/Res_img/<%= restaurantImage %>" alt="Restaurant logo">
                                                </a>
                                            </div>
                                            <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                                <h5><a href="dishes.jsp?res_id=<%= restaurantId %>"><%= restaurantTitle %></a></h5>
                ...
                <%
                        ...
                        if (resultSetRestaurants != null) resultSetRestaurants.close();
                        if (stmtRestaurants != null) stmtRestaurants.close();
                        if (resultSetCategory != null) resultSetCategory.close();
